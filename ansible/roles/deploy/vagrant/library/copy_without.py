...
---
module: copy_without
version_added: "deploy/vagrant"
short_description: Copies files to remote locations. (without a given set)
description:
     - The M(copy) module copies a file on the local box to remote locations. With the option to exclude some.
options:
  without:
    description:
      - Exclusions
